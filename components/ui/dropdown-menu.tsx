...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2.5 py-1.5 text-xs font-normal text-subtle-fg data-[inset]:pl-8",
        className
      )}
      {...props}
    />
